/**
Jasmine typings, with custom matchers added to Matchers interface
I haven't found a better way of doing this :(
**/
...
declare namespace jasmine {
  ...
  interface Matchers {
    ...
    // hacking my custom matcher here
    toBeWithinDelta(expected: any, expectationFailOutput?: any): boolean;
